...
module.exports = class VOID {
  ...
  serverCount(message) {
    fetch(`https://dcbotlist.xyz/api/bots/stats`, {
        method: 'POST',
        headers: { 
  ...
  async search(id) {
  return await fetch(`https://dcbotlist.xyz/api/bots/${id}`, {
        method: 'GET'
    })
  ...
  async hasVoted(id) {
  return await fetch(`https://dcbotlist.xyz/api/bots/check/${id}`, {method: 'GET',headers: { 
